...
int D1_GEMV00a_XP() {
	...
	int cut1[5] = {0,66,80,0,0};
	int cut2[5] = {0,0,0,0,0};
	...
	dummy->SetLineWidth(0);	TLegend *leg = new TLegend(0.15,0.70,0.33,0.87,"GEMV00a");
	leg->AddEntry( gr[0], "Straight" );
	leg->AddEntry( gr[1], "yb=66 ; st=0" );
	leg->AddEntry( gr[2], "yb=80 ; st=0" );
